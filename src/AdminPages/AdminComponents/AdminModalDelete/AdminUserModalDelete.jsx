...
const AdminUserModalDelete = ({ isDelete, setIsDelete, open, setOpen, userId }) => {
            ...
            >
                <Box sx={style}>
                    ...
                    <div style={{ padding: '10px 20px', height: 100 }}>
                        <Typography fontSize={24}>Are you sure to delete user #{userId} ?</Typography>
                    </div>
                    <div style={{ borderBottom: '1px solid #929395' }}>
                    </div>
...
export default AdminUserModalDelete;